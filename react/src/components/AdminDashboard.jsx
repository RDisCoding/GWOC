...
const AdminDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
            ...
            <div className="w-full max-w-6xl">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded transition-colors ${isAcceptingOrders
              ...
              {currentOrders.length === 0 ? (
                ...
                <div className="space-y-4 max-h-[calc(100vh-180px)] overflow-y-auto bg-white rounded-lg">
                  {currentOrders.map((order) => (
                    <div key={order.order_id} className="border p-6 rounded-lg shadow-md text-center">
      ...
      case "Order History":
        return (
          <div className="p-6 flex flex-col items-center h-full bg-pink-50">
            <div className="w-full max-w-6xl">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Order History</h2>
                <button
                  className={`px-4 py-2 rounded ${isAcceptingOrders
                      ? "bg-green-500 hover:bg-green-600 text-white"
                      : "bg-red-500 hover:bg-red-600 text-white"
                    }`}
                >
