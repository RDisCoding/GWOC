  ...
  const pages = [
    {
      title: "Desserts",
      items: [
        { id: 1, name: "Churros", price: 199, image_url: "/api/placeholder/300/300" },
        { id: 2, name: "Mini Donut", price: 199, image_url: "/api/placeholder/300/300" },
        { id: 3, name: "Mini Red Velvet Muffins", price: 299, image_url: "/api/placeholder/300/300" },
        { id: 4, name: "Vanilla Bites", price: 299, image_url: "/api/placeholder/300/300" },
        { id: 5, name: "Brownie Bites", price: 149, image_url: "/api/placeholder/300/300" },
        { id: 6, name: "Chocolate Sticks", price: 149, image_url: "/api/placeholder/300/300" } // Fixed ID
      ]
    },
    {
      title: "Dips",
      items: [
        { id: 7, name: "Hazelnut", price: 199, image_url: "/api/placeholder/300/300" },
        { id: 8, name: "Dark Chocolate", price: 545, image_url: "/api/placeholder/300/300" },
        { id: 9, name: "Cream Cheese", price: 499, image_url: "/api/placeholder/300/300" },
        { id: 10, name: "Strawberry", price: 249, image_url: "/api/placeholder/300/300" },
        { id: 11, name: "Milk Chocolate", price: 249, image_url: "/api/placeholder/300/300" }, // Fixed ID
        { id: 12, name: "White Chocolate", price: 249, image_url: "/api/placeholder/300/300" }, // Fixed ID
      ]
    }
  ];
